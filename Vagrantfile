...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "lane-maxwell-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/terrafirmaeng"
  #   chef.validation_client_name = "terrafirmaeng-validator"
  #   chef.validation_key_path = ".chef/terrafirmaeng-validator.pem"
  # end
end
